...
module CodeBox
  ...
  module CodeAttribute
    ...
    module ClassMethods
      ...
      def code_attribute(code_name, options={})
        ...
        code_attr_name         = (opts.delete(:attribute_name) || "#{code_name}_#{code_attr_suffix}").to_s
        code_class_name        = opts.delete(:class_name) || "::Codes::#{code_name.to_s.camelize}"
        ...
        case lookup_type
          when :cache
            ...
            RUBY_
          when :association
            association_options = opts.merge({
