  ...
  module Utility
    ...
    def ensure_module(base, module_base_name: 'CodeBoxActsAsCode', prepend_base_name: true)
      ...
      begin
        ...
        mod = Module.new
        base.const_set(module_base_name, mod)
      end
    ...
    def i18n_attribute_value_key(model_class, attribute, code_value, i18n_model_segment: CodeBox::ActsAsCode.i18n_model_segment)
      "#{CodeBox::Utility.i18n_value_scope(model_class, i18n_model_segment)}.#{attribute}.#{code_value}"
    end

    module_function :ensure_module, :i18n_value_scope, :i18n_attribute_value_key
  end
end
